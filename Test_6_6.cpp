...
void main() {
	...
	cout << "str length = " << mystrlen(str.c_str()) << endl;
}
...
/*void main() {
	...
	lt1.erase(lt1.begin());
	lt1.erase(--lt1.end());
	auto it = find(lt1.begin(), lt1.end(), 8);
	lt1.erase(it);
	for (const auto& e : lt1)
		cout << e << " ";
	cout << endl;
